      ...
      <div class="grid lg:grid-cols-12 gap-8 lg:gap-12">
        ...
        <main class="lg:col-span-7 space-y-6">
          ...
          <footer class="glossary-panel">
            ...
            <div class="flex flex-col items-center relative -mt-5 z-20 pointer-events-none" ref="donationRef">
              <transition name="pop">
                <div v-if="showDonationOptions" 
                    class="absolute bottom-full mb-6 w-full max-w-xl bg-white border border-slate-200/60 rounded-[2.5rem] p-6 shadow-dropdown pointer-events-auto z-50">
              ...
              <button @click.stop="showDonationOptions = !showDonationOptions" 
                      class="support-trigger-btn group relative z-30 pointer-events-auto"
